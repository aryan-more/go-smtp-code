...
var Goodbye = SmtpCode{Code: 221, EnhancedCodes: [3]int16{2,0,0}}

var AuthenticationSucceeded = SmtpCode{Code: 235, EnhancedCodes: [3]int16{2,7,0}}
...
var PasswordRequired = SmtpCode{Code: 432, EnhancedCodes: [3]int16{4,7,12}}
...
var ImapServerUnavailable = SmtpCode{Code: 451, EnhancedCodes: [3]int16{4,4,1}}

var InsufficientSystemStorage = SmtpCode{Code: 452, EnhancedCodes: NoEnhancedCodes}

var TemporaryAuthFail = SmtpCode{Code: 454, EnhancedCodes: [3]int16{4,7,0}}
...
var AuthExchangeLineIsTooLong = SmtpCode{Code: 500, EnhancedCodes: [3]int16{5,5,6}}

var SyntaxErrorInParametersOrArguments = SmtpCode{Code: 501, EnhancedCodes: NoEnhancedCodes}

var CannotBase64DecodeClientResponses = SmtpCode{Code: 501, EnhancedCodes: [3]int16{5,5,2}}

var ClientInitiatedAuthenticationExchange = SmtpCode{Code: 501, EnhancedCodes: [3]int16{5,7,0}}
...
var UnrecognizedAuthenticationType = SmtpCode{Code: 504, EnhancedCodes: [3]int16{5,5,4}}
...
var AuthenticationRequired = SmtpCode{Code: 530, EnhancedCodes: [3]int16{5,7,0}}

var AuthenticationMechanismIsWeak = SmtpCode{Code: 534, EnhancedCodes: [3]int16{5,7,9}}

var AuthenticationCredentialsInvalid = SmtpCode{Code: 535, EnhancedCodes: [3]int16{5,7,8}}

var EncryptionRequiredForRequestedAuthMechanism = SmtpCode{Code: 538, EnhancedCodes: [3]int16{5,7,11}}
...
var MessageTooBigForSystem = SmtpCode{Code: 554, EnhancedCodes: [3]int16{5,3,4}}
